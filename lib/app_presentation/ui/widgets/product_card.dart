                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Card(
                              ...
                              child: GetBuilder<CreateAndRemoveWishListState>(
                                builder: (createAndRemoveWishListState) {
                                  int id=widget.productListByRemark.id??0;
                                  return InkWell(
                                      onTap:widget.productId !=null?()async{
                                        bool result=  await createAndRemoveWishListState.getToRemoveWishList(id);
                                       if(result){
                                         await Get.find<WishListState>().getWishList();
                                         Get.showSnackbar( GetSnackBar(
                                           title: 'remove success',
                                           message: createAndRemoveWishListState.message,
                                           isDismissible: true,
                                      ...
                                      bool result= await createAndRemoveWishListState.getToCreateWishList(id);
                                      if(result){
